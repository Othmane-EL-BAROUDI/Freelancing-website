...
<body>
    ...
    <div class="grid-container">
        ...
        <section>
            <nav>
                <a href="admins.php" class="name_page">Edit Admin</a>
                ...
                <form method="post" style="width: 50vw;">
                    <div class="row mt-4">
                        <div class="col">
                            ...
                            <input name="first_name_admin" type="text" class="form-control" value = "<?php  echo $row['first_name_admin'] ?>">
                        </div>

                        <div class="col">
                            <small class="text-muted mt-3">Last name :</small>
                            <input name="last_name_admin" type="text" class="form-control" value = "<?php  echo $row['last_name_admin'] ?>">
                        </div>
                    </div>

                    <div class="mt-4">
                        <small class="text-muted mt-2">Email :</small>
                        <input name="email_admin" type="email" class="form-control" id="inputEmail3" value = "<?php  echo $row['email_admin'] ?>">
                    </div>

                    <div class="mt-4">
                        <small class="text-muted mt-2">Password :</small>
                        <input name="password_admin" type="password" class="form-control" value = "<?php  echo $row['password_admin'] ?>">
                    </div>
                    
                    <div class="text-center mt-4">
                        <button type="submit" class="btn btn-primary mx-2" name="submit">Update</button>
                        <button type="button" class="btn btn-danger mx-2" onclick="window.location.href='admins.php'">Close</button>
                    </div>
                </form>
            </div>
        </div>
