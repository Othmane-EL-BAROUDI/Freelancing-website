<?php
    ...
    $sqlstate = $pdo->prepare('SELECT * FROM suivi_job 
...
<html lang="en">
    ...
    <body>
        <header class="header">
            <section class="flex">
            <a href="My_Requests.php" class="logo">My request</a>
                <div class="icons">
        ...
        <section class="home-grid">
            ...
            <div class="box">
                        ...
                        <p class="tutor">Here you can see the request u send, and if they got accepted or no. </p>
                        <hr>
            </div>
        </section>
                ...
                <div class="review">
                    <div class="reviewer-info">
                        <div class="reviewer-name">
                            <h3> The job : <?php echo $jobs['title']; ?></h3>
                            <p>You sent a request : <h4> <?php echo $jobs['status'];?></h4> <hr></p>
                        </div>
                    </div>
                    <div class="review-content">
                        <h3> You sent the request at : <?php echo $jobs['time_sent'];?></h3>
                        <p> Your request accepted at : <?php echo $jobs['time_accepted'] ?></p>
                    </div>
                </div>
                <?php
            }?>
